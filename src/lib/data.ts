...
export const blogPosts = [
  ...
  {
    title: "构建高性能 React 应用：从理论到实践",
    excerpt: "深入探讨 React 并发特性、Suspense 边界和选择性水合的最佳实践...",
    date: "2024-03-15",
    tags: ["React", "Performance"],
    slug: "high-performance-react",
  },
  {
    title: "Three.js 粒子系统实战指南",
    excerpt: "从零构建一个交互式粒子背景，涵盖 GPU 实例化和着色器编程...",
    date: "2024-02-28",
    tags: ["Three.js", "WebGL"],
    slug: "threejs-particle-system",
  },
  {
    title: "微前端架构的演进与选择",
    excerpt: "对比 iframe、Module Federation 和 Web Components 三种方案的优劣...",
    date: "2024-01-20",
    tags: ["Architecture", "Frontend"],
    slug: "micro-frontend-evolution",
  },
]
